...
require (
	...
	github.com/lightstep/otel-launcher-go v1.18.6
...
require (
	...
	github.com/lightstep/otel-launcher-go/lightstep/sdk/metric v1.18.6 // indirect
	github.com/lightstep/otel-launcher-go/pipelines v1.18.6 // indirect
